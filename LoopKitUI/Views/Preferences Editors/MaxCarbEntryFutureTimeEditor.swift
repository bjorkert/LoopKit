//
//  MaxCarbEntryFutureTimeEditor.swift
//  LoopKitUI
//
...
public struct MaxCarbEntryFutureTimeEditor: View {
    @Environment(\.appName) private var appName
    
    let viewModel: MaxCarbEntryFutureTimeEditorViewModel
...
/*        self.mode = mode
        ...
        self.viewModel = MaxCarbEntryFutureTimeEditorViewModel(
            preferencesViewModel: preferencesViewModel,
            didSave: didSave
        )
    }
    ...
    public var body: some View {
        Text("Hej från MaxCarbEntryFutureTimeEditor")
        /*
        TimeEditor(
